...
final case class ServiceDescriptorProto(
    ...
    def getOptions: com.google.protobuf.descriptor.ServiceOptions = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(options, com.google.protobuf.descriptor.ServiceOptions.defaultInstance)
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.google.protobuf.descriptor.ServiceDescriptorProto] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.google.protobuf.descriptor.ServiceDescriptorProto(
        ...
        _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(__fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.collection.Seq[com.google.protobuf.descriptor.MethodDescriptorProto]]), _root_.scala.collection.Seq.empty),
