...
final case class FileOptions(
    ...
    def getJavaPackage: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaPackage, "")
    ...
    def getJavaOuterClassname: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaOuterClassname, "")
    ...
    def getJavaMultipleFiles: Boolean = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaMultipleFiles, false)
    ...
    def getJavaGenerateEqualsAndHash: Boolean = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaGenerateEqualsAndHash, false)
    ...
    def getJavaStringCheckUtf8: Boolean = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaStringCheckUtf8, false)
    ...
    def getOptimizeFor: com.google.protobuf.descriptor.FileOptions.OptimizeMode = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(optimizeFor, com.google.protobuf.descriptor.FileOptions.OptimizeMode.SPEED)
    ...
    def getGoPackage: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(goPackage, "")
    def clearGoPackage: FileOptions = copy(goPackage = None)
    def withGoPackage(__v: String): FileOptions = copy(goPackage = Some(__v))
    def getCcGenericServices: Boolean = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(ccGenericServices, false)
    ...
    def getJavaGenericServices: Boolean = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaGenericServices, false)
    ...
    def getPyGenericServices: Boolean = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(pyGenericServices, false)
    ...
    def getCcEnableArenas: Boolean = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(ccEnableArenas, false)
    ...
    def getObjcClassPrefix: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(objcClassPrefix, "")
    ...
    def getCsharpNamespace: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(csharpNamespace, "")
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaPackage.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
        case 8 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaOuterClassname.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
        case 10 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaMultipleFiles.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 20 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaGenerateEqualsAndHash.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 27 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaStringCheckUtf8.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 9 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(optimizeFor.map(__e => _root_.scalapb.descriptors.PEnum(__e.scalaValueDescriptor)), _root_.scalapb.descriptors.PEmpty)
        case 11 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(goPackage.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
        case 16 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(ccGenericServices.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 17 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(javaGenericServices.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 18 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(pyGenericServices.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 23 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(deprecated.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 31 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(ccEnableArenas.map(_root_.scalapb.descriptors.PBoolean(_)), _root_.scalapb.descriptors.PEmpty)
        case 36 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(objcClassPrefix.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
        case 37 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(csharpNamespace.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
