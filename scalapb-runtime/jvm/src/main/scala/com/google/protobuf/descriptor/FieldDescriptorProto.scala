...
final case class FieldDescriptorProto(
    ...
    def getLabel: com.google.protobuf.descriptor.FieldDescriptorProto.Label = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(label, com.google.protobuf.descriptor.FieldDescriptorProto.Label.LABEL_OPTIONAL)
    ...
    def getType: com.google.protobuf.descriptor.FieldDescriptorProto.Type = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(`type`, com.google.protobuf.descriptor.FieldDescriptorProto.Type.TYPE_DOUBLE)
    ...
    def getTypeName: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(typeName, "")
    ...
    def getExtendee: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(extendee, "")
    ...
    def getDefaultValue: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(defaultValue, "")
    ...
    def getOneofIndex: Int = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(oneofIndex, 0)
    ...
    def getJsonName: String = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(jsonName, "")
    ...
    def getOptions: com.google.protobuf.descriptor.FieldOptions = _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(options, com.google.protobuf.descriptor.FieldOptions.defaultInstance)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(number.map(_root_.scalapb.descriptors.PInt(_)), _root_.scalapb.descriptors.PEmpty)
        case 4 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(label.map(__e => _root_.scalapb.descriptors.PEnum(__e.scalaValueDescriptor)), _root_.scalapb.descriptors.PEmpty)
        case 5 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(`type`.map(__e => _root_.scalapb.descriptors.PEnum(__e.scalaValueDescriptor)), _root_.scalapb.descriptors.PEmpty)
        case 6 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(typeName.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
        case 2 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(extendee.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
        case 7 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(defaultValue.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
        case 9 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(oneofIndex.map(_root_.scalapb.descriptors.PInt(_)), _root_.scalapb.descriptors.PEmpty)
        case 10 => _root_.com.trueaccord.scalapb.OptionUtil.getOrElse(jsonName.map(_root_.scalapb.descriptors.PString(_)), _root_.scalapb.descriptors.PEmpty)
